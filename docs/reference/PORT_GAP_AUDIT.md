...
| Settings providers/connections diagnostics depth | `settings/*`, `Provider*`, `ConnectionsSettings.tsx` | Partial provider, pairing, endpoint, and diagnostics contracts + provider/connections smoke captures |
