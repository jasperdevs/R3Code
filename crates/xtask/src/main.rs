...
fn classify_inventory_path(path: &str) -> InventoryRow {
        ...
        || path == "packages/contracts/src/rpc.ts"
    {
        ...
        (
            "selected SSH parsing, command arg, output-line, connection-key, remote package-spec, askpass, child-env, and auth-failure helpers in crates/r3_core/src/lib.rs",
            "partial",
        ...
        || path.starts_with("packages/effect-acp/")
    {
        ...
        (
            "selected helpers, including SSH command/auth contracts and pairing endpoint helpers, in crates/r3_core/src/lib.rs",
            "partial",
