...
fn classify_inventory_path(path: &str) -> InventoryRow {
        ...
        || path.starts_with("apps/web/src/router")
    {
        ...
        (
            "branch/git presentation helpers, VCS contract shapes, Git workspace-file/remotes/check-ignore helper contracts in crates/r3_core/src/lib.rs plus VCS process default/error/truncation contracts in crates/r3_core/src/process.rs",
            "partial",
