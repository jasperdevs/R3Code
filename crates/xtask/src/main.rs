...
fn classify_inventory_path(path: &str) -> InventoryRow {
        ...
        || path.starts_with("apps/web/src/router")
    {
        ...
        (
            "source-control presentation plus provider helper contracts, change-request schemas/provider normalizers, GitHub/GitLab/Azure command plans, Bitbucket API request/checkout plans, Bitbucket API discovery/auth contracts, repository clone/publish decision contracts, provider registry binding/unsupported decisions, owner/ref source branch parsing, context fallback, provider error messages, discovery helper contracts, safe auth-line filtering, auth trimming, CLI/VCS probe command plans, VCS probe item mapping, provider CLI discovery specs, GitHub/GitLab/Azure auth parsers, and provider context remote-selection/cache constants in crates/r3_core/src/lib.rs",
            "partial",
        ...
        || path.starts_with("packages/tailscale/src/")
    {
        ...
        (
            "source-control provider/auth/context contracts, change-request state/schema/normalizers, repository clone URL/visibility/info schemas, repository lookup plus clone/publish input/result contracts, provider registration/binding/unsupported-operation contracts, Bitbucket API discovery/auth contracts, and provider operation wire values in crates/r3_core/src/lib.rs",
            "partial",
